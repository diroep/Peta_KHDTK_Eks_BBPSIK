...
map.getView().fit([12237147.177266, -1004468.171483, 12885511.941306, -684922.029960], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Peta KHDTK Eks BBPSIK</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (61 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Klik simbol pohon untuk melihat informasi masing-masing KHDTK';
            }
